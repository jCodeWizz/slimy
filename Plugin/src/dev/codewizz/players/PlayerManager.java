...
public class PlayerManager {
	...
	public void loadInProfile(int level, int levelProgression, int prof, String id, boolean isKing, String kingdom) {
		PlayerInfo f;
		if(kingdom == null) {
			f = new PlayerInfo(UUID.fromString(id), Profession.values()[prof], level, levelProgression, isKing, null);
		} else {
			f = new PlayerInfo(UUID.fromString(id), Profession.values()[prof], level, levelProgression, isKing, UUID.fromString(kingdom));
